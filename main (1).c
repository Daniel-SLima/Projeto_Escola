...
int main() {
					...
					do {
						...
						case 1: {
							if (qtdAlunos < TAM) {
								...
								printf("\nIncluir Aluno\n");
								printf("Matrícula: ");
								scanf("%d", &novo.matricula); //a benção do /n era aqui pqp
                                while (getchar() != '\n'); 
						...
						case 4: {
							...
							for (int i = 0; i < qtdDisciplinas; i++) {
								if (listarDisciplinas[i].codigo == idDisc) {
									...
									// Encontrou o aluno, agora incrementa o contador de disciplinas
									for (int j = 0; j < qtdAlunos; j++) {
                                        if (listarAlunos[j].matricula == idAluno) {
                                            listarAlunos[j].contadorDisciplinas++;  // Incrementando o contador de disciplinas
                                            break;
                                        }
									}	
								...
								if (listarDisciplinas[i].codigo == idDisc) {
									for (int j = 0; j < listarDisciplinas[i].totalAlunos; j++) {
										if (listarDisciplinas[i].alunosIds[j] == idAluno) {
											...
											// Encontrou o aluno, agora decrementa o contador de disciplinas
                                            for (int l = 0; l < qtdAlunos; l++) {
                                                if (listarAlunos[l].matricula == idAluno) {
                                                    listarAlunos[l].contadorDisciplinas--;  // Decrementando o contador de disciplinas
                                                    break;
                                                }
                                            }
    ...
    do {
        ...
        switch (cadastro2) {
            ...
            for (int i = 0; i < qtdAlunos; i++) {
                // Verifica o contador de disciplinas de cada aluno
    ...
    } // Fim do switch (cadastro2)

    } while (cadastro2 != 0); // Fim do do-while
